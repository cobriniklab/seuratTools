...
#'
#' @examples
seuratApp <- function(preset_project, appTitle = "chevreulSeurat", organism_type = "human", bigwig_db = "~/.cache/chevreulSeurat/bw-files.db", db_path = "~/.cache/chevreulSeurat/single-cell-projects.db", futureMb = 13000) {
