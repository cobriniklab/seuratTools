...
#'
#' @examples
seuratApp <- function(preset_project, appTitle = "seuFullLengthViz", organism_type = "human", bigwig_db = "~/.cache/seuFullLengthViz/bw-files.db", db_path = "~/.cache/seuFullLengthViz/single-cell-projects.db", futureMb = 13000) {
    print(packageVersion("seuFullLengthViz"))
    ...
    body <- shinydashboard::dashboardBody(
        ...
        shinydashboard::tabItems(
            ...
            shinydashboard::tabItem(
                ...
                h3(paste0("seuFullLengthViz version: ", packageVersion("seuFullLengthViz"))),
                techInfoui("techInfo")
            )
        )
    )
    ...
    server <- function(input, output, session) {
        ...
        shinyhelper::observe_helpers(help_dir = system.file("helpers", package = "seuFullLengthViz"))
        options(warn = -1)
        ...
        observe({
            ...
            shiny::withProgress(
                ...
                value = 0,
                {
                    ...
                    updated_seu <- update_seuFullLengthViz_object(seu_path = uploadSeuratPath(), organism = organism)
                    seu(updated_seu)
        ...
        observeEvent(input$regressAction, {
            ...
            regressed_seu <- seuFullLengthViz::regress_by_features(seu(),
