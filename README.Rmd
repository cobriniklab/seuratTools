...
> [!WARNING]
> chevreulSeurat was designed for full-length smart-seq based single cell data. Default settings may not be appropriate for droplet (10x) data, though most can be adjusted. Keep in mind [best practices](https://satijalab.org/seurat/articles/pbmc3k_tutorial) regarding normalization, dimensional reduction, etc. when using. 

## Installation

You can install the released version of chevreulSeurat from <a href="https://github.com/whtns/chevreulSeurat" target="_blank" rel="noopener noreferrer">github</a> with:
